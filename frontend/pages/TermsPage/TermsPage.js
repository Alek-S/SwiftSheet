...
const TermsPage = () => {
	...
	return (
		<Policy>
			<div>
				<h1>SwiftSheet Terms of Service</h1>
				<h3> SwiftSheet is located at: https://swiftsheet.app/</h3>

				<p>
					These terms and conditions outline the rules and regulations for the
					use of SwiftSheet's Website.
				</p>

				<p>
					By accessing this website we assume you accept these terms and
					conditions in full. Do not continue to use SwiftSheet's website if you
				...
				<h2>License</h2>
				<p>
					Unless otherwise stated, SwiftSheet and/or it's licensors own the
					intellectual property rights for all material on SwiftSheet. All
					intellectual property rights are reserved. You may view and/or print
					pages from https://swiftsheet.app for your own personal use subject to
					restrictions set in these terms and conditions.
				</p>
				<p>You must not:</p>
				<ol>
					<li>Republish material from https://SwiftSheet.app</li>
					<li>
						Sell, rent or sub-license material from https://swiftsheet.app
					</li>
					<li>
						Reproduce, duplicate or copy material from https://swiftsheet.app
					</li>
				</ol>
				<p>
					Redistribute content from SwiftSheet (unless content is specifically
				...
				<p>
					...
					outweighs the absence of SwiftSheet; and (d) where the link is in the
				...
				<p>
					No use of SwiftSheet's logo or other artwork will be allowed for
				...
				<p>
					...
					loss or damage of any nature. We also remind users that this website
					is provided and maintained on a volunteer basis, with limited
					supervision and provided as-is.
				</p>
				...
				<p>
					...
					contact us via <a href="mailto:swiftsheetapp@gmail.com">email</a>.
				</p>
			</div>
		</Policy>
	);
