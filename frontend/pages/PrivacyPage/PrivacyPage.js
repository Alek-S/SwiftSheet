	...
	return (
		<Policy>
			...
			<p>
				...
				(hereinafter, "us", "we", or "swiftsheet.app"). We respect your privacy
			...
			<p>
				...
				request. SwiftSheet's purpose in collecting non-personally identifying
				information is to better understand how SwiftSheet's visitors use its
				website. From time to time, SwiftSheet may release
				non-personally-identifying information in the aggregate, e.g., by
				publishing a report on trends in the usage of its website.
			</p>
			<p>
				SwiftSheet also collects potentially personally-identifying information
				like Internet Protocol (IP) addresses for logged in users and for users
				leaving comments on http://swiftsheet.app blog posts. SwiftSheet only
			...
			<p>
				Certain visitors to SwiftSheet's websites choose to interact with
				SwiftSheet in ways that require SwiftSheet to gather
				personally-identifying information. The amount and type of information
				that SwiftSheet gathers depends on the nature of the interaction. For
				example, we ask visitors who sign up for a blog at http://swiftsheet.app
			...
			<p>
				...
				Privacy Policy covers the use of cookies by SwiftSheet and does not
			...
			<p>
				Although most changes are likely to be minor, SwiftSheet may change its
				Privacy Policy from time to time, and in SwiftSheet's sole discretion.
				SwiftSheet encourages visitors to frequently check this page for any
			...
			<p>
				...
				via <a href="mailto:noradbase@gmail.com">email</a> or{' '}
				<a href="tel:6127107372">phone</a>.
			</p>
		</Policy>
	);
};
